...
public class FastDFSClient {
	...
	//group1/M00/00/00/rBDHA1wTK3eAUnCkAAAFSQy1dxc203.png
	//groupName:group1
	//remoteFileName:M00/00/00/rBDHA1wTK3eAUnCkAAAFSQy1dxc203.png
	public static int deleteFile(String groupName, String remoteFileName)
			throws Exception {
		StorageClient storageClient = getTrackerClient();
		int ret = storageClient.delete_file(groupName, remoteFileName);
		//ret = 0 删除成功，ret = 2文件不存在
		return ret;
	}
	...
	public static String getTrackerUrl() throws IOException {
	    //带端口路径 http://47.99.170.201:8080/group1/M00/00/00/rBDHA1wTKgSARgWgAAAFSQy1dxc903.png
		//return "http://"+getTrackerServer().getInetSocketAddress().getHostString()+":"+ClientGlobal.getG_tracker_http_port()+"/";
	    //不带端口路径 http://47.99.170.201:8080/group1/M00/00/00/rBDHA1wTKgSARgWgAAAFSQy1dxc903.png
